...
<body>
    ...
    <img src="el5.jfif" class="card-img-top" alt="...">
    <div class="card-body">
    ...
    <div class="col-md-4 mt-5">
    <div class="card" style="width: 18rem;">
    <img src="el2.jfif" class="card-img-top" alt="...">
    <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
    <a href="login.php" class="btn btn-primary">ADD</a>
    ...
    <div class="col-md-4 mt-5">
    <div class="card" style="width: 18rem;">
    <img src="el3.jfif" class="card-img-top" alt="...">
    <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
    <a href="login.php" class="btn btn-primary">ADD</a>
    ...
    <div class="col-md-4 mt-5">
    <div class="card" style="width: 18rem;">
    <img src="electric-4.jpg" class="card-img-top" alt="...">
    <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
    <a href="login.php" class="btn btn-primary">ADD</a>
    ...
    <div class="col-md-4 mt-5">
    <div class="card" style="width: 18rem;">
    <img src="electric-1.jpg" class="card-img-top" alt="...">
    <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
    <a href="login.php" class="btn btn-primary">ADD</a>
    ...
    <div class="col-md-4 mt-5">
    <div class="card" style="width: 18rem;">
    <img src="el6.jfif" class="card-img-top" alt="...">
    <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
    <a href="login.php" class="btn btn-primary">ADD</a>
